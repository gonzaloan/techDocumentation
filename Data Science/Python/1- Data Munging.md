...
Podemos llamar a **dtypes** en un dataset, para ver los tipos de datos de cada columna.  Podemos además, reasignar data d


> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjA4Mjc4MjY4LDcwMDg3MjE3OSwtMjA2OD
